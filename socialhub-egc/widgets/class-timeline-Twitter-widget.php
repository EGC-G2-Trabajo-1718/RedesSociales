<?php
/**
 * Timeline_Twitter_Widget
 *
 * This widget implements the timeline for a user social network.
 *
 * @see WP_Widget
 */
class Timeline_Twitter_Widget extends WP_Widget {
	const BASE_ID = 'timeline-Twitter-egc';
	...
	public function widget($args, $instance) {
		...
		//TWITTER
		$user = getUsernameTwitter($instance, 'twitter');	
		if ($user!="")		
...
function getUsernameTwitter($instance, $socialnetwork){
