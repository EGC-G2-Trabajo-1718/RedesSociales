 ...
 * Timelines_Widget
 *
 * This widget implements the timelines for a user social network.
 *
 * @see WP_Widget
 */
class Timelines_Widget extends WP_Widget {
	const BASE_ID = 'timelines-egc';
	...
	public static function getDescription() {
		return 'This widget implements the timelines for a user social network.';
	}
